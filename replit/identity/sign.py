...
import pyseto
from identity.goval.api import signing_pb2
...
class SigningAuthority:
    ...
    def __init__(
        ...
        """
        self.identity = verify.verify_identity_token(marshaled_identity,
                                                     replid, pubkey_source)
        self.signing_authority = verify.get_signing_authority(
            marshaled_identity)
